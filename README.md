...
* **⚡ Double/Triple Shift:** Tap either `Left Shift` or `Right Shift` twice to correct the current word; tap it three times to correct the complete buffered phrase and switch layout (e.g., English ↔ Ukrainian).
* **🖋️ Auto-Correction:** It corrects the last word or complete phrase without a separate correction key.
